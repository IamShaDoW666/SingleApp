    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
      <form @submit.prevent="submit">
        ...
        <div class="mt-4">
          ...
          <textarea id="content" type="text" rows="4" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-smmt-1 block w-full" v-model="form.content"></textarea>
